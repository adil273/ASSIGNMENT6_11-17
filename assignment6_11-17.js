...
var FriendsNames11 = ["Ali", "Ahmad", "Aslam"];
for (var i = 0; i < FriendsNames11.length; i++) {
...
//name.
var FriendsNames12 = ["Ali", "Ahmad", "Aslam"];
for (var i = 0; i < FriendsNames12.length; i++) {
...
var MyCar = ["White Color", "Good Fuel Average", "AC", "excellent Suspension"];
for (let i = 0; i < 1; i++) {
...
let DinnerInv14 = ["Manto", "Newton", "Putin"];
for (let i = 0; i < DinnerInv14.length; i++) {
...
let DinnerInvDel = ["Manto", "Newton", "Putin"];
for (let i = 0; i < 1; i++) {
...
let DinnerInvAdd = ["Manto", "Newton", "Putin"];
{
...
//still in your list.
for (let i = 0; i < DinnerInvAdd.length; i++) {
...
let DinnerInvMore = ["Manto", "Newton", "Putin"];
{
    DinnerInvMore.splice(2, 1, "King Salman");
    console.log(DinnerInvMore);
}
for (let i = 0; i < DinnerInvMore.length; i++) {
...
let DinnerShrink = ["Shoaib", "Manto", "Tesla", "Newton", "King Salman", "Babar"];
{
...
let DinnerShrink1 = ["Shoaib", "Manto", "Tesla", "Newton", "King Salman", "Babar"];
for (let i = 5; i > 1; i--) {
...
for (let j = 0; j < DinnerShrink1.length; j++) {
